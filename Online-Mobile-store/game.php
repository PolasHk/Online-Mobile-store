  ...
  <div id="view">
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
          <h2 class="subheader biggest">Download Games  <br />
		  </h2>
          <div class="item first">
		  	<p>
            <?php
				include "connection.php";
				$q1=mysql_query("select * from dd_game");
				if(0< (mysql_num_rows($q1)))
				{
					echo "<div a='a' align='left' class='in'><ul>";
					while($row=mysql_fetch_array($q1))
					{
			  			echo "&nbsp; &nbsp; &nbsp; &nbsp;<li><a href='download_notice.php?filetype=3&fpath=upload/game/$row[2]'><font color='#990033' size='+1'>".$row[1]."</font></a></li><br><br>";
					}
					echo "</h5></div>";
			  }
			  else
			  {
			  	echo "<div class='in'>";
			  	echo "<h4> <font color='orange'> Game file is not found </font></h4>";
				echo "</div>";
			}
			  ?>
			  </p>

  ...
  <div id="view">
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
          <h2 class="subheader biggest">Bollywood Latest</h2>
          <div class="item first">
		  	<div class="in">
			 <a href="download_home.php">
			  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="542" height="188">
                  <param name="movie" value="flash/omu_herobanner_V2.swf" />
                  <param name="quality" value="high" />
                  <embed src="flash/omu_herobanner_V2.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="542" height="188"></embed>
			  </object>
			  </a>
			</div>
          </div>

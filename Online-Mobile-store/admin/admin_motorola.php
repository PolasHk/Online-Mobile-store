  ...
  <div id="view">
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
		 <h2 class="subheader biggest">Motorola</h2>
          <div class="item first">
            <div class="in">
                ...
                <h6 class="subheader biggest" style="font-size:18px;">
                  <?php
					...
					$q=mysql_query("select * from dd_category where c_id = 4");
			...
			<h2 class="subheader biggest">Motorola Product's</h2>
			<div class="item first">
            	<div class="in">
					<?php
						include "connection.php";
						$qry = mysql_query("SELECT * FROM `dd_product` WHERE c_id = 4 ");
						...
						while($row = mysql_fetch_array($qry))			
						{
							...
							echo "<td><a href='edit_motorola_product.php?id=$row[0]'>Edit</a></td>";
							echo "<td><a href='delete_product.php?id=$row[0]&cid=4'>Delete</a></td></tr>";
						}
...
<div class="box submenu">
  ...
  <div class="in">
    <ul>
      ...
      <li><a href="admin_motorola.php"><font color="#009933">Motorola</font></a></li>
...
<?php	
	...
	if(isset($_POST['submit']))
	{
		...
		mysql_query("UPDATE `dd_category` SET `enable` = '$enable' WHERE `c_id` =4");

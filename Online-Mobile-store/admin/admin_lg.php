...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="cs" lang="cs">
  ...
  <div id="view">
      ...
      <div id="head">
        ...
        <h2 id="searchForm"><font size="+2" color="#006633"><a href="admin_logout.php">log out</a><a href="logout.php"></a></font></h2>
      </div>
      <!-- // Header -->
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
		 <h2 class="subheader biggest">LG</h2>
          <div class="item first">
            <div class="in">
                ...
                <h6 class="subheader biggest" style="font-size:18px;">
                  <?php
					...
					$q=mysql_query("select * from dd_category where c_id = 5");
			...
			<h2 class="subheader biggest">LG  Product's</h2>
			<div class="item first">
            	<div class="in">
					<?php
						include "connection.php";
						$qry = mysql_query("SELECT * FROM `dd_product` WHERE c_id = 5 ");
						...
						while($row = mysql_fetch_array($qry))			
						{
							...
							echo "<td><a href='edit_lg_product.php?id=$row[0]'>Edit</a></td>";
							echo "<td><a href='delete_product.php?id=$row[0]&cid=5'>Delete</a></td></tr>";
						}
...
<div class="box submenu">
  ...
  <div class="in">
    <ul>
      ...
      <li><a href="admin_lg.php"><font color="#009933">LG </font></a></li>
    </ul>
  </div>
</div>
<div class="submenu" align="center"></div>
  ...
  <!-- // Menu -->
     ...
     <div id="foot">
       ...
       <p class="copy small">Copyright@ My Mobile Strore.All rihght reserved.</p>
     </div>
    <!-- // Foot -->
...
<?php	
	...
	if(isset($_POST['submit']))
	{
		...
		mysql_query("UPDATE `dd_category` SET `enable` = '$enable' WHERE `c_id` =5");

  ...
  <div id="view">
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
		 <h2 class="subheader biggest">Sony</h2>
          <div class="item first">
            <div class="in">
                ...
                <h6 class="subheader biggest" style="font-size:18px;">
                  <?php
					...
					$q=mysql_query("select * from dd_category where c_id = 3");
			...
			<h2 class="subheader biggest">Sony Product's</h2>
			<div class="item first">
            	<div class="in">
					<?php
						include "connection.php";
						...
						while($row = mysql_fetch_array($qry))			
						{
							...
							echo "<td><a href='edit_sony_product.php?id=$row[0]'>Edit</a></td>";
...
<div class="box submenu">
  ...
  <div class="in">
    <ul>
      ...
      <li><a href="admin_sony.php"><font color="#009933">Sony</font></a></li>
...
<?php	
	...
	if(isset($_POST['submit']))
	{
		...
		mysql_query("UPDATE `dd_category` SET `enable` = '$enable' WHERE `c_id` = 3");

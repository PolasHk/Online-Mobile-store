  ...
  <div id="view">
    ...
    <div id="content">
        ...
        <div id="contentBlock" align="center">
          <h2 class="subheader biggest">Welcome To Purchase</h2>
          <br />
          <br />
		  <div class="item first">
            <?php
				...
				$id=$_REQUEST['id'];
				$qry=mysql_query("select * from dd_product where p_id=$id");
				if(0< mysql_num_rows($qry))
				{
					while($row=mysql_fetch_array($qry))
					{
			  			...
			  			<table>
			  			<tr>
							<td><img src='upload/product/big/$row[6]' height=200 width=200/></td>

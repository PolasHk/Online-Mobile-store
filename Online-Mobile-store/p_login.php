  ...
  <div id="view">
        ...
        <!-- Right sidebox -->
          <div class="item first">
            <div class="in" align="center">
              <form action="check_price.php" method="post">
                <h5>&nbsp;</h5>
                <h5 >User Name
                  <input type="text" name="t1" style="background-color:#CCCCCC"/>
                    
                    <p>&nbsp;</p>
                  <p>Password  &nbsp;
                        <input type="password" name="t2" style="background-color:#CCCCCC;" />
                  </p>
                  <p>&nbsp;</p>
                  <p>
		  ...
		  <p>&nbsp;</p>
		  <h6>If you don't have an account, Want to purchase?</h6>
		  <p><a href="signup1.php"><h4>Sign Up</h4></a>
	        </p>
		</div>
          </div>
      	<div align="center">
      ...
      <div id="menu">
        <ul id="mainMenu">
          ...
          <li><strong>Price List</strong></a></li>

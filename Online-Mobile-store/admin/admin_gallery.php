  ...
  <div id="view">
      ...
      <div id="content">
        ...
        <div id="contentBlock" align="center">
		 <h2 class="subheader biggest">Gallery's</h2>
            ...
            <div class="in">
              <h6 class="subheader biggest" style="font-size:12px;">
				...
				<?php
					...
					$qry=mysql_query("select * from dd_gallery");
					while($row=mysql_fetch_array($qry))
					{
						echo "<tr align='left'><td>$row[0]</td><td>$row[1]</td><td>$row[2]</td><td><a href='delete_file.php?id=$row[0]&file=$row[2]&type=Gallery'>Delete</a></td></tr>";
					}
          ...
          <div class="box submenu">
            ...
            <div class="in">
              <ul>
				...
				<li><a href="admin_gallery.php"><font color="#009933">Gallery</font></a></li>
              </ul>
            </div>
          </div>
